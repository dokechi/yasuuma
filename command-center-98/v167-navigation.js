...
(()=>{
  ...
  const deskNames={x:'カード投稿',fp:'お金投稿',house:'家投稿',career:'上場',sourcing:'仕入れ',reddit:'海外差'};
  ...
  function sync(){
    ...
    by('ccPageDescription').textContent=generic
      ...
      : {x:'新着から候補を選び、原稿を確認できます。',fp:'お金の投稿原稿を、新しいものから確認できます。',house:'家の投稿原稿を、新しいものから確認できます。',career:'上場企業の投稿原稿を、新しいものから確認できます。',sourcing:'候補・調査・購入履歴を切り替えて確認できます。',reddit:'海外との価格差と投稿候補を確認できます。'}[view]||'';
